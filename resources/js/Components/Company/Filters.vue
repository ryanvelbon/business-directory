...
const sortOptions = [
  { name: 'Best Match', href: '#' },
  { name: 'Best Rating', href: '#' },
  { name: 'Distance', href: '#' },
  { name: 'Alphabetically', href: '#' },
]
const filters = [
  {
    id: 'types',
  ...
  <div class="bg-gray-50">
    ...
    <div class="max-w-3xl mx-auto px-4 text-center sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <section aria-labelledby="filter-heading" class="border-t border-gray-200 py-6">
        <h2 id="filter-heading" class="sr-only">Company filters</h2>
        ...
        <div class="flex items-center justify-between">
          ...
          <PopoverGroup class="hidden sm:flex sm:items-baseline sm:space-x-8">
            <Popover as="div" v-for="(section, sectionIdx) in filters" :key="section.name" :id="`desktop-menu-${sectionIdx}`" class="relative z-10 inline-block text-left">
              <div>
